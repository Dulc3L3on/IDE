...
{//esta será la tabla donde se almacenan los valores
 //de cadenas que son empleadas con regularidad durante 
 //todo el lenguaje o un programa en específico, su objetivo
 //general es ser un punto de convergencia a donde se pueda
 //Acudir para buscar información de manera seguida, de tal 
 //manera que no sea necesario recurrir a un autómata para 
 //hallarlo puesto que en algunos casos no es lo necesario y en 
 //otros alarga más el proceso...


    class TablaSimbolos
    {//asumo que lo mejor para almacenar a las palabras reservadas y demás componentes léxicos ya definidos
     //será muy útil emplear una enumeración para cada una de dichas clasificaciones        
    ...
    //lo que se hará será separar los análisisi según las agrupaciones de los colores, si el color es diferente entonces amerita que esté en otro método o además de esto en otra
    //Enumeración...
}
